...
export default function ChatAuthor({
	...
	return (
		<>
			...
			>
				<div>
					<header className='dark:bg-secondary-dark-2 border-b-secondary/5 dark:border-b-secondary-dark flex h-20 items-center justify-between gap-3 rounded-lg border-b-2'>
