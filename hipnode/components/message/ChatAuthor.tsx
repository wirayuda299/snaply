...
export default function ChatAuthor({
  ...
  return (
    <>
      ...
      >
        <div>
          <header className="flex h-20 items-center justify-between gap-3 rounded-lg border-b-2 border-b-secondary/5 dark:border-b-secondary-dark dark:bg-secondary-dark-2">
          ...
          <div className="mt-3 min-h-screen divide-y divide-secondary-light overflow-y-auto">
