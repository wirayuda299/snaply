						...
						<DialogContent>
							<div>
								{users?.map((user) => (
									<div
										key={user._id}
										className='bg-white-700 dark:bg-primary-dark/90 flex w-full items-center gap-3 rounded-md p-4 '
									>
										<Image
										...
										>
											{user.username}
											<p className='text-secondary dark:text-secondary-light cursor-auto text-xs font-light lowercase'>
