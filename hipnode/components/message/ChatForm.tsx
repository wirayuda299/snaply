						...
						<FormItem>
							<FormLabel htmlFor='image' className='cursor-pointer'>
								{isChecking['media.image'] ? (
									<div className='ease border-primary size-6 animate-spin rounded-full border-t-2 transition-all duration-1000'></div>
								) : (
						...
						<FormItem className='w-full'>
							<FormControl className='w-full'>
								<div className='flex w-full items-center'>
									...
									>
										{isPending ? (
											<div className='ease border-white-700 size-6 animate-spin rounded-full border-t-2 transition-all duration-1000'></div>
										) : (
											<Send />
										)}
									</Button>
