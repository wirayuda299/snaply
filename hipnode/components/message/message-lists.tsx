	...
	return (
		<div className='dark:bg-secondary-dark-2 col-span-2 flex h-screen w-full flex-col bg-white p-5 lg:col-span-1'>
			<div
				...
				ref={containerRef}
			>
				<header className='border-b-secondary/5 dark:border-b-secondary-dark dark:bg-secondary-dark-2 mb-auto flex h-20 items-center justify-between gap-3 border-b bg-white'>
						...
						{id && isLoading ? (
							<div className='flex min-h-screen justify-center pt-5'>
								<div className='mx-auto flex size-32 flex-col items-center justify-center'>
									<div className='ease duration-&lsqb;5000&rsqb; border-primary size-20 animate-spin rounded-full border-t-2 transition-all'></div>
