...
export default function SearchResult({
	...
	return (
		<div
			ref={ref}
			className='dark:border-secondary-dark dark:bg-primary-dark absolute left-0 top-14 z-50 !w-full max-w-xl rounded-lg border bg-white p-3'
		>
			<div className='no-scrollbar border-white-700 border-b-white-800 dark:border-b-secondary flex w-full items-center gap-3 overflow-x-auto border-b pb-3'>
