    ...
    <nav className="relative flex items-center justify-end bg-white p-3 dark:bg-primary-dark md:justify-between lg:sticky lg:top-0 lg:z-50  lg:p-5">
      ...
      <form className="flex items-center gap-3 rounded-lg max-md:w-auto md:w-[200px] md:flex-row-reverse md:bg-white-800 md:p-1 dark:md:bg-secondary-dark lg:w-[400px]">
        ...
        <input
          ...
          type="search"
          placeholder="Search...."
          className="hidden bg-transparent pl-2 focus-visible:absolute focus-visible:left-0 focus-visible:block focus-visible:bg-white-700 focus-visible:outline-none max-md:focus-visible:w-full md:block md:w-full focus-visible:md:static "
          id="search"
        />
      </form>
      <div className="flex items-center gap-2 sm:gap-5">
        ...
        <button className="flex w-8 items-center gap-2 md:w-auto">
          <Image
            ...
            alt=" user"
          />
          <h2 className="hidden text-lg font-semibold capitalize dark:text-white-700 md:block">
