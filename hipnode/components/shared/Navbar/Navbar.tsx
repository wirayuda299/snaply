...
export default async function Navbar() {
  ...
  return (
    <nav className="!fixed inset-x-0 top-0 z-50 flex items-center justify-end  bg-white p-3 dark:bg-primary-dark md:justify-between lg:p-5">
      <Link
        href={"/"}
      ...
      >
        <Image
          ...
          alt="Logo"
        />
        <h1 className="hidden dark:text-white-700 lg:block">Snaply</h1>
      </Link>
      <NavLink />
      <SearchForm />
      <div className="flex items-center gap-2">
        ...
        <div className="flex w-8 items-center gap-3 md:w-auto">
          <Image
            ...
            alt="user"
          />
          <p className="hidden text-lg font-semibold capitalize dark:text-white-700 md:block">
