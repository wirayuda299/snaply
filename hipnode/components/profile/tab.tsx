...
export default function Tab() {
  ...
  return (
    <div className="bg-white-700 dark:bg-secondary-dark-2 no-scrollbar flex  w-full snap-mandatory justify-center gap-5 overflow-x-auto rounded p-2  md:justify-evenly md:p-4">
      {tabs.map((tab) => (
        <Link
